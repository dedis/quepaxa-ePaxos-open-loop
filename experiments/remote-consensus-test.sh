...
nohup sshpass ssh -i ${replica1_cert} -n -f ${replica1} ".${remote_server_path}  -port 7070 -maddr 10.156.33.149 --addr 10.156.33.140 -exec  -dreply ${algo}" >${output_path}2.log &
nohup sshpass ssh -i ${replica2_cert} -n -f ${replica2} ".${remote_server_path}  -port 7071 -maddr 10.156.33.149 --addr 10.156.33.141 -exec  -dreply ${algo}" >${output_path}3.log &
nohup sshpass ssh -i ${replica3_cert} -n -f ${replica3} ".${remote_server_path}  -port 7072 -maddr 10.156.33.149 --addr 10.156.33.142 -exec  -dreply ${algo}" >${output_path}4.log &
...
nohup sshpass ssh -i ${client1_cert} ${client1} ".${remote_client_path} -name 5   -maddr 10.156.33.149 -w 50  -c 50 -arrivalRate ${arrival} -clientBatchSize 100 -clientTimeout 60 -defaultReplica 0 -logFilePath ${remote_log_path} ${leader}" >${output_path}5.log &
nohup sshpass ssh -i ${client2_cert} ${client2} ".${remote_client_path} -name 6   -maddr 10.156.33.149 -w 50  -c 50 -arrivalRate ${arrival} -clientBatchSize 100 -clientTimeout 60 -defaultReplica 1 -logFilePath ${remote_log_path} ${leader}" >${output_path}6.log &
      sshpass ssh -i ${client3_cert} ${client3} ".${remote_client_path} -name 7   -maddr 10.156.33.149 -w 50  -c 50 -arrivalRate ${arrival} -clientBatchSize 100 -clientTimeout 60 -defaultReplica 2 -logFilePath ${remote_log_path} ${leader}" >${output_path}7.log
